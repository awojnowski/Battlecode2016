...
public class DirectionController {
    ...
    public RobotType[] safeEnemyTypes = new RobotType[]{ RobotType.ARCHON, RobotType.SCOUT, RobotType.ZOMBIEDEN };
    ...
    private boolean isRobotDangerous(final RobotInfo enemy) {
        ...
        if (distance < this.attackRadiusSquaredWithBuffer(enemy.type.attackRadiusSquared, this.enemyBufferDistance)) {
